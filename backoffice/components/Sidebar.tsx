...
const navItems = [
  ...
  { href: "/channels", label: "Canais", icon: ChannelsIcon },
  { href: "/providers", label: "Provedores", icon: ProvidersIcon },
  { href: "/pricing", label: "Preços", icon: PricingIcon },
  { href: "/calculator-config", label: "Config. Calculadora", icon: ConfigIcon },
];
